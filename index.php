...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && empty($errors)) {
    ...
    $anzahlStellplätzeLastmanagement = $anzahlNachladungen * $anzahlStellplätze;
...
<form action="" method="post">
    ...
    <input type="number" step="0.01" name="input_nutzungsfaktor" value="<?= $_POST['input_nutzungsfaktor'];?>"> (z.B. privat 0.7, gewerblich 0.7)
    können mit der verfügbaren LIS-Anschlussleistung können unter Einsatz eines dynamischen Lastmanagements 
    <?php echo isset($anzahlStellplätzeLastmanagement) ? round($anzahlStellplätzeLastmanagement, 2) :  '___';  ?> Stellplätze parallel versorgt werden.</span>
    </div>
